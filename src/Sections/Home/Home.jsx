    ...
    return (
        <div className="h-screen flex justify-center items-center">
            <div ref={homeRef} className="w-4/6 h-5/6 grid grid-cols-6 grid-rows-5">
                <div className="fade-in-scroll row-start-1 col-start-1 row-span-3 col-span-5 background-box p-4 overflow-auto">
                ...
                <div className="fade-in-scroll row-start-2 col-start-5 row-span-3 col-span-2">
